...
export default defineConfig({
  ...
  shortcuts: {
    ...
    input:
      'flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm text-foreground shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-#a1a1aa disabled:cursor-not-allowed disabled:opacity-50',
